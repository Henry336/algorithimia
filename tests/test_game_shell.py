...
class GameShellTests(unittest.TestCase):
    def test_render_game_shell_includes_current_encounters_and_assets(self) -> None:
        ...
        self.assertIn("data-title-screen", html)
        self.assertIn("Start Chapter 0", html)
        self.assertIn("data-chapter-intro", html)
        self.assertIn("Mira opens the repair channel", html)
        self.assertIn("You're late, but so is the stair. Start with the jam.", html)
        self.assertIn("Begin repair", html)
        self.assertIn("data-room-handoff", html)
        self.assertIn("The stair shudders, then waits.", html)
        self.assertIn("Enter intake", html)
        self.assertIn("Static browser bundle", html)
        self.assertIn("Sorting Slime", html)
        self.assertIn("Triage Line Dispatcher Trial", html)
        self.assertIn("role=\"tablist\"", html)
        self.assertIn("data-build-context", html)
    ...
    def test_render_game_shell_includes_explorable_queueworks_room(self) -> None:
        ...
        self.assertIn("function showChapterZero()", html)
        self.assertIn("function showChapterZeroIntro()", html)
        self.assertIn("function showRoomHandoff()", html)
        self.assertIn("gameRoot.dataset.screen = 'intro'", html)
        self.assertIn("gameRoot.dataset.screen = 'handoff'", html)
        self.assertIn("gameRoot.dataset.screen = 'game'", html)
        self.assertIn("data-start-chapter", html)
        self.assertIn("data-continue-chapter", html)
        self.assertIn("data-enter-room", html)
        self.assertIn("Patchrunner approaching the blocked Queueworks gate", html)
        ...
        self.assertIn("Find the Sorting Slime and inspect the loose runes.", html)
        self.assertIn("Objective: Find the Sorting Slime and inspect the loose runes.", html)
        ...
        self.assertIn("data-room-object=\"sorting_slime\"", html)
        ...
        self.assertIn("The stair accepts the repair and the intake starts moving again.", html)
    ...
    def test_render_game_shell_includes_browser_smoke_harness(self) -> None:
        ...
        self.assertIn("const buildContext = {", html)
        self.assertIn("report.dataset.smokeResult = status", html)
        self.assertIn("report.dataset.smokeLabel = failureLabel", html)
        self.assertIn("function viewportProfile()", html)
        self.assertIn("const category = width <= 480 ? 'mobile/narrow' : width <= 760 ? 'narrow' : 'desktop'", html)
        self.assertIn("const orientation = width >= height ? 'landscape' : 'portrait'", html)
        self.assertIn("report.dataset.smokeViewport = profile.viewport", html)
        self.assertIn("report.dataset.smokeViewportProfile = profile.category", html)
        self.assertIn("report.dataset.smokeOrientation = profile.orientation", html)
        self.assertIn("report.dataset.smokePageSize = profile.page", html)
        self.assertIn("report.dataset.smokeFirstViewport = firstViewportSummary", html)
        self.assertIn("report.dataset.smokeBuild = buildContext.summary", html)
        self.assertIn("report.setAttribute('aria-label', evidenceText)", html)
        self.assertIn("function runGameShellSmoke()", html)
        self.assertIn("title screen is visible before Chapter 0 starts", html)
        self.assertIn("start chapter control is visible on title screen", html)
        self.assertIn("title start control meets 40px tap target", html)
        self.assertIn("Start Chapter 0 reveals intro briefing", html)
        self.assertIn("Chapter 0 intro briefing is visible before room control", html)
        self.assertIn("begin repair control is visible in intro briefing", html)
        self.assertIn("begin repair control meets 40px tap target", html)
        self.assertIn("Begin repair reveals room handoff", html)
        self.assertIn("room handoff is visible before playable room", html)
        self.assertIn("enter intake control is visible in room handoff", html)
        self.assertIn("enter intake control meets 40px tap target", html)
        self.assertIn("Begin repair reveals playable room", html)
        self.assertIn("arrival objective is shown in room log", html)
        self.assertIn("let firstViewportSummary = 'not captured'", html)
        self.assertIn("function visibleInViewport(selector)", html)
        self.assertIn("function captureFirstViewport()", html)
        ...
        self.assertIn("title, Chapter 0 intro, room handoff, arrival objective, first viewport", html)
        self.assertIn("Build", html)
        self.assertIn("local --game-html export", html)
        self.assertIn("Result", html)
        self.assertIn("Control path", html)
        self.assertIn("Start Chapter 0, Begin repair, Enter intake, ArrowRight", html)
        self.assertIn("Viewport", html)
        self.assertIn("Viewport profile", html)
        self.assertIn("Orientation", html)
        self.assertIn("Page size", html)
        self.assertIn("First viewport", html)
        ...
        self.assertIn("self-smoke generated; mark manual capture clear, cropped, or inconclusive during review", html)
        self.assertIn("confirm arrival objective, first-viewport composition, blocked route, interact-ready slime, wrong-order retry, route-clear aftermath, repaired interaction, and narrow/mobile readability", html)
        ...
        self.assertIn("first viewport shows room shell before smoke scroll", html)
        self.assertIn("first viewport shows room status before smoke scroll", html)
        self.assertIn("first viewport shows room hint before smoke scroll", html)
        self.assertIn("['slime', '[data-room-object=\"sorting_slime\"]']", html)
        self.assertIn("room status cue is visible before movement", html)
        self.assertIn("room hint cue is visible before movement", html)
        self.assertIn("arrival objective log is visible before movement", html)
        self.assertIn("build context is visible before smoke scroll", html)
        ...
        self.assertIn("route-clear aftermath appears in room log", html)
        ...
        self.assertIn("copyable smoke evidence includes build context", html)
        self.assertIn("smoke report orientation metadata is captured", html)
