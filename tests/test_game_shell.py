...
class GameShellTests(unittest.TestCase):
    ...
    def test_render_game_shell_includes_browser_smoke_harness(self) -> None:
        ...
        self.assertIn("title, Chapter 0 intro, first viewport", html)
        ...
        self.assertIn("confirm first-viewport composition, blocked route, interact-ready slime, wrong-order retry, route clear, repaired interaction, and narrow/mobile readability", html)
